...
router.get('/batches/:id/edit', requirePermission('inventory.edit'), inventoryController.editBatchForm);
router.post('/batches/:id/edit', requirePermission('inventory.edit'), inventoryController.updateBatch);
